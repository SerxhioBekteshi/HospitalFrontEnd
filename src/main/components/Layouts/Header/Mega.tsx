...
const contact1 = require("../../../assets/images/users/user1.jpg");
const contact2 = require("../../../assets/images/users/user2.jpg");
const contact3 = require("../../../assets/images/users/user3.jpg");
const featureData = [
  {
    id: 1,
    color: "primary",
